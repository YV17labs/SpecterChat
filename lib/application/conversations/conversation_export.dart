...
const _guide = {
  ...
  'whatTheModelSees':
      ...
      'Images attached by the user are sent as image parts of their '
      'message; an image the model generated comes back in a user message '
      'placed after the turn that produced it (after its tool results, if '
      'it called tools), with the text "Image generated by the assistant '
      'on the turn above." — an assistant message takes text parts only. '
      'The exception is a request to an image model, which reads the image '
