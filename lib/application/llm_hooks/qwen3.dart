...
class Qwen3Hook implements LlmHook {
  ...
  static final _modelPattern = RegExp(
    r'qwen3[.\-_]?(5|6)',
    caseSensitive: false,
  );

  @override
  RegExp get modelPattern => _modelPattern;
  ...
  String get hallucinationCorrection =>
      '$correctionPrefix and was discarded. Please try again: either '
      'answer in plain text, or invoke a tool via the proper '
