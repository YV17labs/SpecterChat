...
class _McpServersEditorDialogState extends State<McpServersEditorDialog> {
  ...
  void initState() {
    ...
    _controller = TextEditingController(
      text: _encoder.convert(_serialize(widget.initial)),
    );
    _validate();
...
/// preserving the existing `id` for any server whose name matches a prior
/// entry so its runtime connection survives the edit. Throws
