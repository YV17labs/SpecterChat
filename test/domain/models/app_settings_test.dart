...
void main() {
  ...
  group('GenerationSettings', () {
    ...
    test('roundtrips through JSON', () {
      const settings = GenerationSettings(temperature: 0.5, maxTokens: 2048);
      final json = settings.toJson();
  ...
  group('McpServerConfig', () {
    ...
    test('roundtrips through JSON', () {
      ...
      expect(McpServerConfig.fromJson(json), config);
    });

    test('ignores runtime fields persisted by older versions', () {
  ...
  group('AppSettings', () {
    ...
    test('copyWith preserves unmodified fields', () {
      ...
      final updated = settings.copyWith(defaultSystemPrompt: 'new prompt');
